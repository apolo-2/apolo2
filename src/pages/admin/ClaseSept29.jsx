//  form using useRef, empaquetando todas las variables dentro de el form (opcion recomendada, especial para cuando hay una larga lista de inputs)
...
// version 1 formulario vehiculo, trabajandolo por  input , lo malo es que no es manejable (no recomendada)
